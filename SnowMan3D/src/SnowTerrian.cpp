...
const DWORD SnowTerrian::TerrainVertex::FVF = D3DFVF_XYZ | D3DFVF_TEX1;

SnowTerrian::SnowTerrian(IDirect3DDevice9* device,
...
int SnowTerrian::getHeightmapEntry(int row, int col)
{
	return _heightmap[row * _numVertsPerRow + col];
}

void SnowTerrian::setHeightmapEntry(int row, int col, int value)
{
	_heightmap[row * _numVertsPerRow + col] = value;
}

bool SnowTerrian::computeVertices()
{
	HRESULT hr = 0;
...
bool SnowTerrian::computeIndices()
{
	HRESULT hr = 0;
...
bool SnowTerrian::loadTexture(wchar_t *fileName)
{
	HRESULT hr = 0;
...
bool SnowTerrian::genTexture(D3DXVECTOR3* directionToLight)
{
...
bool SnowTerrian::lightTerrain(D3DXVECTOR3* directionToLight)
{
	HRESULT hr = 0;
...
float SnowTerrian::computeShade(int cellRow, int cellCol, D3DXVECTOR3* directionToLight)
{
...
bool SnowTerrian::readRawFile(std::string fileName)
{
...
float SnowTerrian::getHeight(float x, float z)
{
...
bool SnowTerrian::draw(D3DXMATRIX* world, bool drawTris)
{
	HRESULT hr = 0;
